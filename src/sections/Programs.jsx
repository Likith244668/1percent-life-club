import { ACCENT, MUTED, INK } from '../theme.js'
    ...
    <section id="programs" style={{ padding: 'clamp(48px,6vw,88px) clamp(20px,5vw,64px)' }}>
      <div style={{ maxWidth: '1340px', margin: '0 auto' }}>
        ...
        <div style={{ borderTop: '1px solid #E4DDD3' }}>
          {PROGRAMS.map((p) => (
            <Hoverable key={p.n} as="a" href="#join" style={rowBase} hoverStyle={rowHover}>
              <span style={{ fontFamily: "'Instrument Serif',serif", fontSize: 'clamp(28px,3vw,40px)', color: ACCENT, lineHeight: 1, minWidth: '1.6ch' }}>{p.n}</span>
